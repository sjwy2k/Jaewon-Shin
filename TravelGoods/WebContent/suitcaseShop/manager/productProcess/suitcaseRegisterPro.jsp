...
String saveFolder = "/imageFile"; // 파일이 업로드되는 폴더 지정
String encType = "utf-8"; // 인코딩타입
int maxSize = 2*1024*1024; // 이미지최대 크기 2Mbyte
...
suitcaseProcess.insertSuitcase(suitcase); //DBBean의 상품 정보 입력 메서드 실행

//입력성공시 동일종류로 입력된 상품목록 페이지로 이동
